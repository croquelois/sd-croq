...
### CROQ: Added arguments
parser.add_argument("--image_path", type=str, help="directory where to store image", default=os.path.join(script_path, 'static'))
parser.add_argument("--database_path", type=str, help="directory where to user database", default=os.path.join(script_path, 'database'))
...
### CROQ: I don't have webui so this initialisation stay here
...
options_templates.update(options_section(('saving-images', "Saving images/grids"), {
    ...
    "grid_only_if_multiple": OptionInfo(False, "Do not save grids consisting of one picture"),
    ...
    "export_for_4chan": OptionInfo(False, "If PNG image is larger than 4MB or any dimension is larger than 4000, downscale and save copy as JPG"),
